...
public record CrearCotizacionResponsabilidadCivilDTO(
        ...
        @NotBlank(message = "La ocupación es obligatoria") @Length(max = 50, message = "La ocupación debe tener máximo 50 caracteres") String ocupacion,
        @NotBlank(message = "La ciudad es obligatoria") @Length(max = 50, message = "La ciudad debe tener máximo 50 caracteres") String ciudad
) {
}
